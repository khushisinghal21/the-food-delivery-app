            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="group bg-amber-900/20 p-4 rounded-2xl border-4 border-dashed border-amber-500 backdrop-blur transition-all duration-300 gap-4 flex flex-col items-center hover:border-solid hover:shadow-xl hover:shadow-amber-900/10 transform hover:translate-y-1 animate-fade-in"
                  >
                    <div
                    ...
                    <div className="text-amber-100 mt-4 text-center">
                      ...
                      <div className="flex items-center justify-center gap-3 mt-3">
                        <button
                          ...
                          className="w-8 h-8 rounded-full bg-amber-900/40 flex items-center justify-center hover:bg-amber-800 transition-all duration-200 active:scale-95"
                        >
              ...
              <div className="mt-12 pt-8 border-t border-amber-800/30 animate-fade-in-up">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-8">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    <button className='bg-amber-900/40 px-8 py-3 rounded-full font-cinzel
                    uppercase tracking-wide hover:bg-amber-800/50 transition-all duration-300 text-amber-100 flex items-center gap-2 active:scale-95 '>CheckOut Now</button>
                  </div>
                </div>
              </div>
            </>
