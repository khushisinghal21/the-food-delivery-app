...
import { FaLeaf, FaWineBottle, FaUtensils, FaInfoCircle } from 'react-icons/fa';
import { GiChefToque } from 'react-icons/gi';
import { MdOutlineFastfood } from 'react-icons/md';
import { aboutfeature } from '../../assets/dummydata';
import { Link } from 'react-router-dom';
import AboutImage  from '../../assets/AboutImage.png'; // Assuming you have some custom styles
import FloatingParticle from '../FloatingParticle/FloatingParticle';
import './AboutHome.css'; // Import your custom styles
const AboutHome = () => {
  return (
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative'>
        <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
          <div className='space-y-4 sm:space-y-8 px-4 sm:px-0'>
            ...
            <p className='text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif italic border-l-4 bg-amber-50/60 pl-4 sm:pl-6 py-2 bg-gradient-to-r from-white/5 to-transparent'>
        ...
        <div className='w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative group transform hover:scale-[1.01] transition-all duration-500'>
          <div className='relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-500 shadow-2xl shadow-black/50'>
            <div className='absolute inset-0 bg-gradient-to-br from-amber-400/15 via-transparent to-amber-600/10'></div>
            <img
              src={AboutImage}
              alt='Restaurant'
