...
import { FiGlobe, FiMail, FiMessageSquare } from 'react-icons/fi';
...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 animate-gradient-x py-12 sm:py-16 md:py-20 4xl:px-8 font[Poppins] relative overflow-hidden">
  ...
  <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition duration-300 hover:scale-[1.02] animate-card-float border-1.4 border-amber-500 hover:border-amber-400">
  ...
  <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition duration-300 hover:scale-[1.02] animate-card-float border-1.4 border-green-500 hover:border-green-400">
    ...
    <div className="pl-12 relative space-y-2 z-10">
      <p className="text-amber-100 font-light flex items-center">
        <FiGlobe className='text-green-400 text-xl mr-2'></FiGlobe>
        +91 7879746789
      </p>
    </div>
  </div>

  <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition duration-300 hover:scale-[1.02] animate-card-float border-1.4 border-orange-500 hover:border-orange-400">
  ...
  rounded-2xl p-6 shadow-2xl transform transition duration-300 
  hover:scale-[1.02] animate-card-float border-1.4 border-amber-500 hover:border-amber-400">
  ...
  />
        ...
        <div className='relative '>
            ...
            <textarea rows='4' name='query' value={formData.query} onChange={handleChange}     className='w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30 rounded-xl text-amber-50 focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-amber-200/50'
placeholder='Type Your message here...' required> </textarea>
        ...
        <button
  type='submit'
  className='w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-orange-700 hover:to-orange-700 text-white font-semibold py-3 ppx-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-amber-500/50 justify-center space-x-2 group'
>
